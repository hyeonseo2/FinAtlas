  ...
  return (
    <div className="card">
      <div className="filters">
        ...
        <input placeholder="은행명" value={filters.bank} onChange={(e) => set("bank", e.target.value)} />
        ...
        <input placeholder="기본금리 최소" value={filters.minBaseRate} onChange={(e) => set("minBaseRate", e.target.value)} />
        <input placeholder="최고금리 최소" value={filters.minMaxRate} onChange={(e) => set("minMaxRate", e.target.value)} />
        <input placeholder="현실금리 최소" value={filters.minExpectedRate} onChange={(e) => set("minExpectedRate", e.target.value)} />
        <input placeholder="난이도 최대 점수" value={filters.maxDifficulty} onChange={(e) => set("maxDifficulty", e.target.value)} />
        <input placeholder="적립유형" value={filters.savingType} onChange={(e) => set("savingType", e.target.value)} />
        <select value={filters.sort} onChange={(e) => set("sort", e.target.value)}>
          <option value="interest">정렬: 현실 예상이자</option>
          <option value="expected">현실금리</option>
      ...
      <p className="note">난이도 점수는 높을수록 조건 달성이 쉬움(성공 가능성 큼)입니다.</p>
    </div>
  );
}
