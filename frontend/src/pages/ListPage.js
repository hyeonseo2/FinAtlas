...
export function ListPage() {
    ...
    return (_jsxs("div", { children: [_jsx(FilterPanel, { filters: filters, setFilters: setFilters, terms: terms, bankNames: filteredBankNames }), _jsxs("div", { className: "topline no-wrap", style: { margin: "12px 0", flexWrap: "wrap", gap: 10 }, children: [_jsxs("h3", { className: "no-wrap", children: ["\uC0C1\uD488 \uBAA9\uB85D (", filtered.length, ")"] }), _jsxs("div", { className: "actions nowrap", style: { gap: 8, alignItems: "center", flexWrap: "wrap" }, children: [_jsx("label", { htmlFor: "global-monthly", style: { fontSize: 13 }, children: "\uB0A9\uC785\uAE08" }), _jsx("input", { id: "global-monthly", type: "number", min: 10000, step: 10000, value: payment, onChange: (e) => setPayment(Number(e.target.value || 0)), style: { width: 140 } })] })] }), _jsx(CompareDrawer, { rows: compare, visible: compare.length > 0, onClose: () => setSelected(new Set()), paymentAmount: payment }), _jsx(ProductTable, { rows: pageRows, sortKey: sortKey, sortDirection: sortDirection, paymentAmount: payment, onSort: onSort, onSelect: onSelect, selected: selected }), _jsxs("div", { className: "topline", style: { justifyContent: "space-between", marginTop: 10, gap: 10 }, children: [_jsxs("small", { className: "muted", children: ["\uD45C\uC2DC \uAE30\uC900: \uB0A9\uC785\uAE08 ", payment.toLocaleString("ko-KR"), "\uC6D0"] }), _jsxs("div", { className: "actions", children: [_jsx("button", { type: "button", onClick: () => setPage(Math.max(1, safePage - 1)), disabled: safePage === 1, children: "\uC774\uC804" }), _jsxs("span", { className: "muted", style: { minWidth: 110, textAlign: "center" }, children: [safePage, " / ", totalPages] }), _jsx("button", { type: "button", onClick: () => setPage(Math.min(totalPages, safePage + 1)), disabled: safePage === totalPages, children: "\uB2E4\uC74C" })] })] }), _jsxs("p", { className: "note", style: { marginTop: 8 }, children: ["\uCD5C\uADFC \uC5C5\uB370\uC774\uD2B8: ", meta?.last_success_at ? new Date(meta.last_success_at).toLocaleString() : "-"] }), _jsxs("p", { className: "note", style: { marginTop: 4 }, children: ["\uB4F1\uB85D \uC0C1\uD488 \uC218: ", meta?.normalized_product_count?.toLocaleString() || "-", "\uAC1C \u00B7 \uB178\uCD9C \uC635\uC158 \uC218: ", meta?.normalized_option_count?.toLocaleString() || "-", "\uAC1C"] })] }));
}
